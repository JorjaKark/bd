...
(8, 'Relógio de Cuco', '2023-09-30', 'Colecionáveis e Antiguidades', '30 x 20 x 15 cm', 'Madeira', 1080.00, 2),
(9, 'Conjunto de Tacos de Golf', '2024-10-18', 'Desportos e Lazer', '120 x 20 x 10 cm', 'Vários Metais', 3790.00, 6),
(10, 'Moeda Antiga', '2024-10-20', 'Colecionáveis e Antiguidades', '3 x 3 x 0.2 cm', 'Prata', 600.00, 3),
(11, 'Gira Discos', '2024-11-09', 'Tecnologia e Informática', '40 x 35 x 15 cm', 'Metal e Plástico', 2300.00, 4),
(12, 'Câmara Polaroid', '2024-11-20', 'Tecnologia e Informática', '12 x 10 x 8 cm', 'Plástico', 950.00, 3);


-- Inserção de registos na tabela Estado
INSERT INTO Estado (idEstado, tipo, dataAtribuicaoEstado, idItem) VALUES 
(1, 'penhorado', '2023-08-05', 1),
(2, 'penhorado', '2024-08-08', 2),
(3, 'penhorado', '2024-08-15', 3),
(4, 'penhorado', '2024-08-21', 4),
(5, 'penhorado', '2024-08-26', 5),
(6, 'devolvido', '2023-09-02', 1),
...
(1, 720.00, 792.00, '2023-08-05', '2023-09-05', 1),
...
(8, 540.00, 594.00, '2023-09-30', '2023-10-30', 8),
...
(1, 1, 777777777, 'requisição de empréstimo', 720.00, '2023-08-05', 'dinheiro'),
...
(6, 1, 777777777, 'devolução de empréstimo', 792.00, '2023-09-02', 'dinheiro'),
...
(12, 8, 555666777, 'requisição de empréstimo', 540.00, '2023-09-30', 'dinheiro'),
